...
import 'package:tt9_betweener_challenge/controllers/location_controller.dart';
...
class _ProfileViewState extends State<ProfileView> {
  ...
  late double lattiude;
  late double longtiude;
  List<Placemark>? placemarks;
  Future<void> getLocationInfro() async {
    determinePosition().then((value) async {
      lattiude = value.latitude;
      longtiude = value.longitude;
      placemarks = await placemarkFromCoordinates(lattiude, longtiude);
      setState(() {});
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          //   InkWell(
          //       onTap: () async {
          //         await MapUtils.openMap(lattiude, longtiude)
...
class MapUtils {
  ...
  static Future<void> openMap(double latitude, double longitude) async {
    ...
    await launchUrl(Uri.parse(googleUrl)).onError((error, stackTrace) {
      print(error);
      return true;
    });
  }
